...
@php
    $breadcrumbs = [['label' => 'Home', 'url' => 'home'], ['label' => 'Dashboard', 'url' => 'dashboard']];
@endphp
                ...
                <div class="card-body">
                    ...
                    <div class="direct-chat-messages">
                        ...
                        <div class="direct-chat-msg end">
                            ...
                            <!-- /.direct-chat-infos -->
                            <img class="direct-chat-img" src="{{ Vite::asset('resources/images/user3-128x128.jpg') }}"
                                alt="message user image" />
                            <!-- /.direct-chat-img -->
                    ...
                    <div class="direct-chat-contacts">
                        <ul class="contacts-list">
                            ...
                            <li>
                                <a href="#">
                                    <img class="contacts-list-img"
                                        src="{{ Vite::asset('resources/images/user7-128x128.jpg') }}" alt="User Avatar" />
                                    <div class="contacts-list-info">
                                        <span class="contacts-list-name">
                                            Sarah Doe
                            ...
                            <li>
                                <a href="#">
                                    <img class="contacts-list-img"
                                        src="{{ Vite::asset('resources/images/user3-128x128.jpg') }}" alt="User Avatar" />
                                    <div class="contacts-list-info">
                                        <span class="contacts-list-name">
                                            Nadia Jolie
                            ...
                            <li>
                                <a href="#">
                                    <img class="contacts-list-img"
                                        src="{{ Vite::asset('resources/images/user5-128x128.jpg') }}" alt="User Avatar" />
                                    <div class="contacts-list-info">
                                        <span class="contacts-list-name">
                                            Nora S. Vans
                            ...
                            <li>
                                <a href="#">
                                    <img class="contacts-list-img"
                                        src="{{ Vite::asset('resources/images/user6-128x128.jpg') }}" alt="User Avatar" />
                                    <div class="contacts-list-info">
                                        <span class="contacts-list-name">
                                            John K.
                            ...
                            <li>
                                <a href="#">
                                    <img class="contacts-list-img"
                                        src="{{ Vite::asset('resources/images/user8-128x128.jpg') }}" alt="User Avatar" />
                                    <div class="contacts-list-info">
                                        <span class="contacts-list-name">
                                            Kenneth M.
